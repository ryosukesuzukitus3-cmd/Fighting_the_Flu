...
VIDEO_EFFECT_SPECS: tuple[VideoEffectSpec, ...] = (
    ...
    VideoEffectSpec("anime_impact", "nc172648", "アニメ衝撃・斬撃 / 素材確認（本編不採用）", 18, 18.0, (360, 360)),
    ...
    VideoEffectSpec("angel_flash", "nc268435", "円環レーザー閃光 / 素材確認（本編不採用）", 32, 16.0, (520, 293)),
    ...
    VideoEffectSpec("retro_lasers", "nc97528", "SFレーザー / 素材確認（本編不採用）", 36, 16.0, (800, 450)),
)
