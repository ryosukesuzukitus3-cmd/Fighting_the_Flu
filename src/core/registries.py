...
ENEMY_DEFS: list[EnemyDef] = [
    ...
    EnemyDef("EnemyBilly",    "低速・高HP・補給役", "music/se/アｯー♂.mp3",       1.0, drop_chance=0.0,  stats=EnemyStats(18, 45.0, 18, 45.0, "高HP・鈍足・回復1個(強化なし)"), doc_movement="低速直進",           doc_notes="HP高い、回復1個。強化ドロップは章の配置で指定"),
