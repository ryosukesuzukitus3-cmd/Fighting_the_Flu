...
ENEMY_DEFS: list[EnemyDef] = [
    ...
    EnemyDef("EnemyCoughSprayer", "咳スプレー型",     "music/se/game_explosion9.mp3",     0.75, drop_chance=0.12, stats=EnemyStats(4, 96.0, 10, 128.0, "低速蛇行+扇状咳弾"), doc_movement="蛇行しながら扇状射撃", doc_notes="短い間隔で小型弾を散布"),
    EnemyDef("EnemySporeSplitter", "胞子分裂型",      "music/se/game_explosion9.mp3",     0.85, drop_chance=0.16, stats=EnemyStats(8, 76.0, 18, 98.0, "撃破で胞子ポッド分裂"), doc_movement="低速蛇行・撃破時に分裂", doc_notes="倒すと小型胞子ポッドを放出"),
