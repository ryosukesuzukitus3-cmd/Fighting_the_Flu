...
STANCE_MAX: dict[str | int, float] = {
    ...
    2: 0.0,         # ブロリー: 大技後の隙で反撃、体幹の管理なし
    "2f2": 0.0,      # 超サイヤ人も大技後の反撃を引き継ぐ
...
OVERHEAT_DURATION   = 2.4    # レーザーの冷却ロック時間（秒）
HEAT_AFTER_OVERHEAT = 40.0   # 熱暴走明けの体温（すぐ再過熱しない程度に残す）
