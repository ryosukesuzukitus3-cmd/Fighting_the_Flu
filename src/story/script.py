...
BOSS_INTRO: dict[int, list[Line]] = {
    ...
    4: [
        ...
        Line(BOSS4, "私は棋理の化身です。あなたの盤も、人生も、同じ精度で読みます。"),
        Line(BOSS4, "盤の外で負け続けて、盤の上へ逃げてきましたね。"),
        Line(S,     "……逃げてきたんじゃない。"),
        Line(S,     "ここだけは、正直だと思ったからだ。"),
        Line(BOSS4, "その正直な盤でも、あなたはもう、投げる手を探している。"),
        Line(S,     "……。"),
...
BOSS_MID: dict[str, list[Line]] = {
    ...
    "4mid": [
        ...
        Line(S,     "黙れ。"),
        Line(BOSS4, "黙らせたいのは、私ではない。あなた自身の声でしょう。"),
    ],
    # Form2 開始（_on_form2_transition から再生）
    "4f2": [
        Line(BOSS4_FORM2, "竜王が怖いのではありません。"),
        Line(BOSS4_FORM2, "怖いのは、まだ何者にでもなれた頃の、あなた自身です。"),
        Line(S,           "……四段。"),
        Line(BOSS4_FORM2, "若さ。才能。未来。眩しくて、直視できないのでしょう。"),
        Line(S,           "やめろ。"),
        Line(BOSS4_FORM2, "ならば、乗り越えてみせなさい。ここからは、あなたの終盤力を問います。"),
    ],
    "4f2mid": [
