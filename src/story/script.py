...
BOSS_INTRO: dict[int, list[Line]] = {
    ...
    2: [
        ...
        Line(BOSS2, "残念!! 今のお前のタイムラインには、1いいねの価値もないィ!!"),
        Line(S,     "……声がでかい。"),
        Line(K,     "SNSはだいたい声がでかいにょ。",
                    "中身の薄さを、音量で殴ってくるにょ。"),
        Line(BOSS2, "みんな暮らしをやってるゥ!! やってないのは、お前だけだァ!!"),
        Line(S,     "……まあ、そうかもな。"),
        Line(K,     "おい、今うなずいたにょ。"),
        Line(S,     "うなずいてない。"),
        Line(K,     "うなずいてたにょ。",
    ...
    4: [
        ...
        Line(BOSS4, "形勢判断。お前の人生——後手、敗勢。"),
        Line(S,     "……将棋ソフトみたいな言い方を、しやがって。"),
        Line(BOSS4, "私は棋理の化身だ。お前の盤も、人生も、同じ精度で読む。"),
...
# ステージ番号 → 背景に薄く流れるテキストプール（ステージのテーマに沿った
#   "ノイズ／侵入思考"。GAMEOVER と同じドライな声で、道中の空気を作る）。
